    ...
    <div class="hidden sm:flex sm:w-[750px] sm:h-[750px] sm:bg-white sm:my-2 sm:px-4 sm:py-4 sm:mx-auto sm:overflow-auto">
      <div ref="contentToPrint">
        ...
        <div class="py-5">
          ...
          <p class="text-sm font-bold py-5">Cláusula 3ª - DA FINALIDADE DO IMÓVEL</p>   
          ...
          <p class="pb-2">
            ...
            <span class="capitalize" v-if="$state?.agreement[2]">{{ maskMoney($state?.agreement[2]) }} </span><span v-else> ____________.</span> 
          ...
          <p>
            ...
            <span class="capitalize" v-if="$state?.agreement[5]">{{ maskMoney($state?.agreement[5]) }} </span> 
            <span v-else> ____________, </span> 
          ...
          <p class="pb-2">
            ...
            <span class="capitalize" v-if="$state?.agreement[6]">{{ maskMoney($state?.agreement[6]) }}.</span> 
            <span v-else> ____________.</span> 
