...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold">🏠 Locação Residencial</h1>
        <p class="text-gray text-sm mt-1">
          Contratos de aluguel de imóveis residenciais.
        </p>
      </div>
      <nuxt-link
        to="/dashboard/contracts/new-residential"
    ...
    >
      <p class="text-gray text-base mb-3">
        Nenhum contrato residencial criado.
      </p>
      <nuxt-link
