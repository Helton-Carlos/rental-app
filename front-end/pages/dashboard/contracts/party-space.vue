...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold">🎉 Espaço de Festa</h1>
        <p class="text-gray text-sm mt-1">
          Contratos para clubes, chácaras e salões de festa.
        </p>
      </div>
      <nuxt-link
        to="/dashboard/contracts/new-party-space"
    ...
    >
      <p class="text-gray text-base mb-3">
        Nenhum contrato de espaço de festa criado.
      </p>
      <nuxt-link
