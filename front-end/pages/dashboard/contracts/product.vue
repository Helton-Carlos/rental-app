...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold">⚙️ Produtos / Máquinas</h1>
        <p class="text-gray text-sm mt-1">
          Contratos de locação de equipamentos e máquinas.
        </p>
      </div>
      <nuxt-link
        to="/dashboard/contracts/new-product"
    ...
    >
      <p class="text-gray text-base mb-3">Nenhum contrato de produto criado.</p>
      <nuxt-link
